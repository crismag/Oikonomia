...
- **Stage** is one of **Needs leader**, **Assigned**, **Confirmed**, **Gathering**, **Completed** or **Cancelled**. It follows who is on the row, whether it has been written up and whether it was cancelled; you do not set it by hand here. A cancelled row stays on the schedule, greyed and not editable in place.
