---
id: monthly-calendar.page
title: Monthly Calendar
type: page
category: planning
summary: The month at a glance, filtered by All, Mine, Ministry, LifeGroup or Church, with a day panel for events and tasks.
modules: [planning]
pages: [monthly-calendar]
keywords: [month, calendar, filter, mine, church, day panel, add event, tasks]
aliases:
...
Monthly Calendar answers _when_ things happen. Weekly Agenda is where you run the week.
...
On a wide screen the month is a grid, with the selected day beside it.

- Choose a **day number** to show that day in the panel. **+N more** does the same when a day holds more than two events.
